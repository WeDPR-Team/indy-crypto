...
pub extern "C" fn indy_crypto_cl_issuer_new_credential_def(
    ...
    trace!(
        "indy_crypto_cl_issuer_new_credential_def: >>> credential_schema: {:?}, \
    ...
    trace!(
        "indy_crypto_cl_issuer_new_credential_def: entities: \
         credential_schema: {:?}, \
         non_credential_schema: {:?}, \
         support_revocation: {:?}",
        credential_schema,
    ...
    trace!(
        "indy_crypto_cl_issuer_new_credential_def: <<< res: {:?}",
        res
    );
    res
}
...
pub extern "C" fn indy_crypto_cl_credential_public_key_to_json(
    ...
    trace!(
        "indy_crypto_cl_credential_public_key_to_json: entity >>> credential_pub_key: {:?}",
        credential_pub_key
    );
    ...
    let res = match serde_json::to_string(credential_pub_key) {
        Ok(credential_pub_key_json) => {
            trace!(
                "indy_crypto_cl_credential_public_key_to_json: credential_pub_key_json: {:?}",
    ...
    trace!(
        "indy_crypto_cl_credential_public_key_to_json: <<< res: {:?}",
        res
    );
    res
}
...
pub extern "C" fn indy_crypto_cl_credential_public_key_from_json(
    ...
    trace!(
        "indy_crypto_cl_credential_public_key_from_json: entity: credential_pub_key_json: {:?}",
        credential_pub_key_json
    );
    ...
    let res = match serde_json::from_str::<CredentialPublicKey>(&credential_pub_key_json) {
        Ok(credential_pub_key) => {
            trace!(
                "indy_crypto_cl_credential_public_key_from_json: credential_pub_key: {:?}",
                credential_pub_key
            );
            unsafe {
                *credential_pub_key_p =
                    Box::into_raw(Box::new(credential_pub_key)) as *const c_void;
                trace!(
                    "indy_crypto_cl_credential_public_key_from_json: *credential_pub_key_p: {:?}",
                    *credential_pub_key_p
                );
            }
            ErrorCode::Success
    ...
    trace!(
        "indy_crypto_cl_credential_public_key_from_json: <<< res: {:?}",
        res
    );
    res
}
...
/// * `credential_pub_key` - Reference that contains credential public key instance pointer.
#[no_mangle]
pub extern "C" fn indy_crypto_cl_credential_public_key_free(
    credential_pub_key: *const c_void,
) -> ErrorCode {
    trace!(
        "indy_crypto_cl_credential_public_key_free: >>> credential_pub_key: {:?}",
        credential_pub_key
    );

    check_useful_c_ptr!(credential_pub_key, ErrorCode::CommonInvalidParam1);

    let credential_pub_key = unsafe {
        Box::from_raw(credential_pub_key as *mut CredentialPublicKey);
    };
    trace!(
        "indy_crypto_cl_credential_public_key_free: entity: credential_pub_key: {:?}",
        credential_pub_key
    );
    ...
    trace!(
        "indy_crypto_cl_credential_public_key_free: <<< res: {:?}",
        res
    );
    res
}
...
pub extern "C" fn indy_crypto_cl_credential_private_key_to_json(
    ...
    trace!(
        "indy_crypto_cl_credential_private_key_to_json: entity >>> credential_priv_key: {:?}",
    ...
    let res = match serde_json::to_string(credential_priv_key) {
        Ok(credential_priv_key_json) => {
            trace!(
                "indy_crypto_cl_credential_private_key_to_json: credential_priv_key_json: {:?}",
                secret!(&credential_priv_key_json)
            );
            unsafe {
                let credential_priv_key_json =
                    CTypesUtils::string_to_cstring(credential_priv_key_json);
    ...
    trace!(
        "indy_crypto_cl_credential_private_key_to_json: <<< res: {:?}",
        res
    );
    res
}
...
/// * `credential_priv_key_p` - Reference that will contain credential private key instance pointer.
#[no_mangle]
pub extern "C" fn indy_crypto_cl_credential_private_key_from_json(
    ...
    trace!(
        "indy_crypto_cl_credential_private_key_from_json: entity: credential_priv_key_json: {:?}",
        secret!(&credential_priv_key_json)
    );
    ...
    let res = match serde_json::from_str::<CredentialPrivateKey>(&credential_priv_key_json) {
        Ok(credential_priv_key) => {
            trace!(
                "indy_crypto_cl_credential_private_key_from_json: credential_priv_key: {:?}",
                secret!(&credential_priv_key)
            );
            unsafe {
                *credential_priv_key_p =
                    Box::into_raw(Box::new(credential_priv_key)) as *const c_void;
                trace!(
                    "indy_crypto_cl_credential_private_key_from_json: *credential_priv_key_p: {:?}",
                    *credential_priv_key_p
                );
            }
            ErrorCode::Success
    ...
    trace!(
        "indy_crypto_cl_credential_private_key_from_json: <<< res: {:?}",
        res
    );
    res
}
...
/// * `credential_priv_key` - Reference that contains credential private key instance pointer.
#[no_mangle]
pub extern "C" fn indy_crypto_cl_credential_private_key_free(
    credential_priv_key: *const c_void,
) -> ErrorCode {
    trace!(
        "indy_crypto_cl_credential_private_key_free: >>> credential_priv_key: {:?}",
        credential_priv_key
    );

    check_useful_c_ptr!(credential_priv_key, ErrorCode::CommonInvalidParam1);

    let _credential_priv_key = unsafe {
        Box::from_raw(credential_priv_key as *mut CredentialPrivateKey);
    };
    trace!(
        "indy_crypto_cl_credential_private_key_free: entity: credential_priv_key: {:?}",
    ...
    trace!(
        "indy_crypto_cl_credential_private_key_free: <<< res: {:?}",
        res
    );
    res
}
...
#[no_mangle]
pub extern "C" fn indy_crypto_cl_credential_key_correctness_proof_to_json(
        ...
        Ok(credential_key_correctness_proof_json) => {
            ...
            unsafe {
                let credential_key_correctness_proof_json =
                    CTypesUtils::string_to_cstring(credential_key_correctness_proof_json);
                *credential_key_correctness_proof_json_p =
    ...
    trace!(
        "indy_crypto_cl_credential_key_correctness_proof_to_json: <<< res: {:?}",
        res
    );
    res
}
...
#[no_mangle]
pub extern "C" fn indy_crypto_cl_credential_key_correctness_proof_from_json(
    ...
    trace!(
        "indy_crypto_cl_credential_key_correctness_proof_from_json: <<< res: {:?}",
        res
    );
    res
}
...
/// * `credential_key_correctness_proof` - Reference that contains credential key correctness proof instance pointer.
#[no_mangle]
pub extern "C" fn indy_crypto_cl_credential_key_correctness_proof_free(
    credential_key_correctness_proof: *const c_void,
) -> ErrorCode {
    ...
    trace!(
        "indy_crypto_cl_credential_key_correctness_proof_free: <<< res: {:?}",
        res
    );
    res
}
...
pub extern "C" fn indy_crypto_cl_issuer_new_revocation_registry_def(
    ...
    trace!(
        "indy_crypto_cl_issuer_new_revocation_registry_def: <<< res: {:?}",
        res
    );
    res
}
...
pub extern "C" fn indy_crypto_cl_revocation_key_public_to_json(
    ...
    trace!(
        "indy_crypto_cl_revocation_key_public_to_json: entity >>> rev_key_pub: {:?}",
        rev_key_pub
    );
    ...
    let res = match serde_json::to_string(rev_key_pub) {
        Ok(rev_key_pub_json) => {
            trace!(
                "indy_crypto_cl_revocation_key_public_to_json: rev_key_pub_json: {:?}",
                rev_key_pub_json
            );
            unsafe {
                ...
                *rev_key_pub_json_p = rev_reg_def_pub_json.into_raw();
                trace!(
                    "indy_crypto_cl_revocation_key_public_to_json: rev_key_pub_json_p: {:?}",
                    *rev_key_pub_json_p
                );
            }
            ErrorCode::Success
    ...
    trace!(
        "indy_crypto_cl_revocation_key_public_to_json: <<< res: {:?}",
        res
    );
    res
}
...
pub extern "C" fn indy_crypto_cl_revocation_key_public_from_json(
    ...
    trace!(
        "indy_crypto_cl_revocation_key_public_from_json: entity: rev_key_pub_json: {:?}",
        rev_key_pub_json
    );
    ...
    let res = match serde_json::from_str::<RevocationKeyPublic>(&rev_key_pub_json) {
        Ok(rev_key_pub) => {
            trace!(
                "indy_crypto_cl_revocation_key_public_from_json: rev_key_pub: {:?}",
                rev_key_pub
            );
            unsafe {
                *rev_key_pub_p = Box::into_raw(Box::new(rev_key_pub)) as *const c_void;
                trace!(
                    "indy_crypto_cl_revocation_key_public_from_json: *rev_key_pub_p: {:?}",
                    *rev_key_pub_p
                );
            }
            ErrorCode::Success
    ...
    trace!(
        "indy_crypto_cl_revocation_key_public_from_json: <<< res: {:?}",
        res
    );
    res
}
...
#[no_mangle]
pub extern "C" fn indy_crypto_cl_revocation_key_public_free(
    rev_key_pub: *const c_void,
) -> ErrorCode {
    trace!(
        "indy_crypto_cl_revocation_key_public_free: >>> rev_key_pub: {:?}",
        rev_key_pub
    );

    check_useful_c_ptr!(rev_key_pub, ErrorCode::CommonInvalidParam1);
    let rev_key_pub = unsafe {
        Box::from_raw(rev_key_pub as *mut RevocationKeyPublic);
    };
    trace!(
        "indy_crypto_cl_revocation_key_public_free: entity: rev_key_pub: {:?}",
        rev_key_pub
    );
    ...
    trace!(
        "indy_crypto_cl_revocation_key_public_free: <<< res: {:?}",
        res
    );
    res
}
...
pub extern "C" fn indy_crypto_cl_revocation_key_private_to_json(
    ...
    trace!(
        "indy_crypto_cl_revocation_key_private_to_json: entity >>> rev_key_priv: {:?}",
        secret!(&rev_key_priv)
    );
    ...
    let res = match serde_json::to_string(rev_key_priv) {
        Ok(rev_key_priv_json) => {
            trace!(
                "indy_crypto_cl_revocation_key_private_to_json: rev_key_priv_json: {:?}",
            ...
            unsafe {
                ...
                *rev_key_priv_json_p = rev_reg_def_priv_json.into_raw();
                trace!(
                    "indy_crypto_cl_revocation_key_private_to_json: rev_key_priv_json_p: {:?}",
                    *rev_key_priv_json_p
                );
            }
            ErrorCode::Success
    ...
    trace!(
        "indy_crypto_cl_revocation_key_private_to_json: <<< res: {:?}",
        res
    );
    res
}
...
pub extern "C" fn indy_crypto_cl_revocation_key_private_from_json(
    ...
    trace!(
        "indy_crypto_cl_revocation_key_private_from_json: entity: rev_key_priv_json: {:?}",
        secret!(&rev_key_priv_json)
    );
    ...
    let res = match serde_json::from_str::<RevocationKeyPrivate>(&rev_key_priv_json) {
        Ok(rev_key_priv) => {
            trace!(
                "indy_crypto_cl_revocation_key_private_from_json: rev_key_priv: {:?}",
                secret!(&rev_key_priv)
            );
            unsafe {
                *rev_key_priv_p = Box::into_raw(Box::new(rev_key_priv)) as *const c_void;
                trace!(
                    "indy_crypto_cl_revocation_key_private_from_json: *rev_key_priv_p: {:?}",
                    *rev_key_priv_p
                );
            }
            ErrorCode::Success
    ...
    trace!(
        "indy_crypto_cl_revocation_key_private_from_json: <<< res: {:?}",
        res
    );
    res
}
...
pub extern "C" fn indy_crypto_cl_revocation_key_private_free(
    ...
    trace!(
        "indy_crypto_cl_revocation_key_private_free: >>> rev_key_priv: {:?}",
        rev_key_priv
    );

    check_useful_c_ptr!(rev_key_priv, ErrorCode::CommonInvalidParam1);

    let _rev_key_priv = unsafe {
        Box::from_raw(rev_key_priv as *mut RevocationKeyPrivate);
    };
    trace!(
        "indy_crypto_cl_revocation_key_private_free: entity: rev_key_priv: {:?}",
    ...
    trace!(
        "indy_crypto_cl_revocation_key_private_free: <<< res: {:?}",
        res
    );
    res
}
...
pub extern "C" fn indy_crypto_cl_revocation_registry_to_json(
    ...
    trace!(
        "indy_crypto_cl_revocation_registry_to_json: >>> rev_reg: {:?}, rev_reg_json_p: {:?}",
        rev_reg,
        rev_reg_json_p
    );
    ...
    trace!(
        "indy_crypto_cl_revocation_registry_to_json: entity >>> rev_reg: {:?}",
        rev_reg
    );
    ...
    let res = match serde_json::to_string(rev_reg) {
        Ok(rev_reg_json) => {
            trace!(
                "indy_crypto_cl_revocation_registry_to_json: rev_reg_json: {:?}",
                rev_reg_json
            );
            unsafe {
                ...
                *rev_reg_json_p = rev_reg_json.into_raw();
                trace!(
                    "indy_crypto_cl_revocation_registry_to_json: rev_reg_json_p: {:?}",
                    *rev_reg_json_p
                );
            }
            ErrorCode::Success
    ...
    trace!(
        "indy_crypto_cl_revocation_registry_to_json: <<< res: {:?}",
        res
    );
    res
}
...
pub extern "C" fn indy_crypto_cl_revocation_registry_from_json(
    ...
    trace!(
        "indy_crypto_cl_revocation_registry_from_json: >>> rev_reg_json: {:?}, rev_reg_p: {:?}",
        rev_reg_json,
        rev_reg_p
    );
    ...
    trace!(
        "indy_crypto_cl_revocation_registry_from_json: entity: rev_reg_json: {:?}",
        rev_reg_json
    );
    ...
    let res = match serde_json::from_str::<RevocationRegistry>(&rev_reg_json) {
        Ok(rev_reg) => {
            trace!(
                "indy_crypto_cl_revocation_registry_from_json: rev_reg: {:?}",
                rev_reg
            );
            unsafe {
                *rev_reg_p = Box::into_raw(Box::new(rev_reg)) as *const c_void;
                trace!(
                    "indy_crypto_cl_revocation_registry_from_json: *rev_reg_p: {:?}",
                    *rev_reg_p
                );
            }
            ErrorCode::Success
    ...
    trace!(
        "indy_crypto_cl_revocation_registry_from_json: <<< res: {:?}",
        res
    );
    res
}
...
#[no_mangle]
pub extern "C" fn indy_crypto_cl_revocation_registry_free(rev_reg: *const c_void) -> ErrorCode {
    trace!(
        "indy_crypto_cl_revocation_registry_free: >>> rev_reg: {:?}",
        rev_reg
    );
    ...
    let rev_reg = unsafe {
        Box::from_raw(rev_reg as *mut RevocationRegistry);
    };
    trace!(
        "indy_crypto_cl_revocation_registry_free: entity: rev_reg: {:?}",
        rev_reg
    );
    ...
    trace!(
        "indy_crypto_cl_revocation_registry_free: <<< res: {:?}",
        res
    );
    res
}
...
#[no_mangle]
pub extern "C" fn indy_crypto_cl_revocation_tails_generator_to_json(
    ...
    trace!(
        "indy_crypto_cl_revocation_tails_generator_to_json: entity >>> rev_tails_generator: {:?}",
        rev_tails_generator
    );
    ...
    let res = match serde_json::to_string(rev_tails_generator) {
        Ok(rev_tails_generator_json) => {
            trace!(
                "indy_crypto_cl_revocation_tails_generator_to_json: rev_tails_generator_json: {:?}",
                rev_tails_generator_json
            );
            unsafe {
                let rev_tails_generator_json =
                    CTypesUtils::string_to_cstring(rev_tails_generator_json);
    ...
    trace!(
        "indy_crypto_cl_revocation_tails_generator_to_json: <<< res: {:?}",
        res
    );
    res
}
...
/// * `rev_tails_generator_p` - Reference that will contain revocation tails generator instance pointer
#[no_mangle]
pub extern "C" fn indy_crypto_cl_revocation_tails_generator_from_json(
    ...
    let res = match serde_json::from_str::<RevocationTailsGenerator>(&rev_tails_generator_json) {
        Ok(rev_tails_generator) => {
            trace!(
                "indy_crypto_cl_revocation_tails_generator_from_json: rev_tails_generator: {:?}",
                rev_tails_generator
            );
            unsafe {
                *rev_tails_generator_p =
    ...
    trace!(
        "indy_crypto_cl_revocation_tails_generator_from_json: <<< res: {:?}",
        res
    );
    res
}
...
pub extern "C" fn indy_crypto_cl_revocation_tails_generator_free(
    ...
    trace!(
        "indy_crypto_cl_revocation_tails_generator_free: >>> rev_tails_generator: {:?}",
        rev_tails_generator
    );

    check_useful_c_ptr!(rev_tails_generator, ErrorCode::CommonInvalidParam1);

    let rev_tails_generator = unsafe {
        Box::from_raw(rev_tails_generator as *mut RevocationTailsGenerator);
    };
    trace!(
        "indy_crypto_cl_revocation_tails_generator_free: entity: rev_tails_generator: {:?}",
        rev_tails_generator
    );
    ...
    trace!(
        "indy_crypto_cl_revocation_tails_generator_free: <<< res: {:?}",
        res
    );
    res
}
...
pub extern "C" fn indy_crypto_cl_credential_signature_to_json(
    ...
    trace!(
        "indy_crypto_cl_credential_signature_to_json: entity >>> credential_signature: {:?}",
    ...
    let res = match serde_json::to_string(credential_signature) {
        Ok(credential_signature_json) => {
            trace!(
                "indy_crypto_cl_credential_signature_to_json: credential_signature_json: {:?}",
                secret!(&credential_signature_json)
            );
            unsafe {
                let credential_signature_json =
                    CTypesUtils::string_to_cstring(credential_signature_json);
    ...
    trace!(
        "indy_crypto_cl_credential_signature_to_json: <<< res: {:?}",
        res
    );
    res
}
...
pub extern "C" fn indy_crypto_cl_credential_signature_from_json(
    ...
    trace!(
        "indy_crypto_cl_credential_signature_from_json: entity: credential_signature_json: {:?}",
        secret!(&credential_signature_json)
    );
    ...
    let res = match serde_json::from_str::<CredentialSignature>(&credential_signature_json) {
        Ok(credential_signature) => {
            trace!(
                "indy_crypto_cl_credential_signature_from_json: credential_signature: {:?}",
                secret!(&credential_signature)
            );
            unsafe {
                *credential_signature_p =
                    Box::into_raw(Box::new(credential_signature)) as *const c_void;
                trace!(
                    "indy_crypto_cl_credential_signature_from_json: *credential_signature_p: {:?}",
                    *credential_signature_p
                );
            }
            ErrorCode::Success
    ...
    trace!(
        "indy_crypto_cl_credential_signature_from_json: <<< res: {:?}",
        res
    );
    res
}
...
pub extern "C" fn indy_crypto_cl_credential_signature_free(
    ...
    trace!(
        "indy_crypto_cl_credential_signature_free: >>> credential_signature: {:?}",
        credential_signature
    );

    check_useful_c_ptr!(credential_signature, ErrorCode::CommonInvalidParam1);

    let _credential_signature = unsafe {
        Box::from_raw(credential_signature as *mut CredentialSignature);
    };
    trace!(
        "indy_crypto_cl_credential_signature_free: entity: credential_signature: {:?}",
        secret!(_credential_signature)
    );
    let res = ErrorCode::Success;

    trace!(
        "indy_crypto_cl_credential_signature_free: <<< res: {:?}",
        res
    );
    res
}
...
#[no_mangle]
pub extern "C" fn indy_crypto_cl_signature_correctness_proof_to_json(
        ...
        Ok(signature_correctness_proof_json) => {
            ...
            unsafe {
                let signature_correctness_proof_json =
                    CTypesUtils::string_to_cstring(signature_correctness_proof_json);
    ...
    trace!(
        "indy_crypto_cl_signature_correctness_proof_to_json: <<< res: {:?}",
        res
    );
    res
}
...
pub extern "C" fn indy_crypto_cl_signature_correctness_proof_from_json(
    ...
    trace!(
        "indy_crypto_cl_signature_correctness_proof_from_json: <<< res: {:?}",
        res
    );
    res
}
...
pub extern "C" fn indy_crypto_cl_signature_correctness_proof_free(
    ...
    trace!(
        "indy_crypto_cl_signature_correctness_proof_free: >>> signature_correctness_proof: {:?}",
        signature_correctness_proof
    );

    check_useful_c_ptr!(signature_correctness_proof, ErrorCode::CommonInvalidParam1);

    let signature_correctness_proof = unsafe {
        Box::from_raw(signature_correctness_proof as *mut SignatureCorrectnessProof);
    };
    trace!("indy_crypto_cl_signature_correctness_proof_free: entity: signature_correctness_proof: {:?}", signature_correctness_proof);
    let res = ErrorCode::Success;

    trace!(
        "indy_crypto_cl_signature_correctness_proof_free: <<< res: {:?}",
        res
    );
    res
}
...
pub extern "C" fn indy_crypto_cl_revocation_registry_delta_to_json(
        ...
        Ok(revocation_registry_delta_json) => {
            ...
            unsafe {
                let revocation_registry_delta_json =
                    CTypesUtils::string_to_cstring(revocation_registry_delta_json);
    ...
    trace!(
        "indy_crypto_cl_revocation_registry_delta_to_json: <<< res: {:?}",
        res
    );
    res
}
...
pub extern "C" fn indy_crypto_cl_revocation_registry_delta_from_json(
    ...
    trace!(
        "indy_crypto_cl_revocation_registry_delta_from_json: <<< res: {:?}",
        res
    );
    res
}
...
pub extern "C" fn indy_crypto_cl_revocation_registry_delta_free(
    ...
    trace!(
        "indy_crypto_cl_revocation_registry_delta_free: >>> revocation_registry_delta: {:?}",
        revocation_registry_delta
    );

    check_useful_c_ptr!(revocation_registry_delta, ErrorCode::CommonInvalidParam1);

    let revocation_registry_delta = unsafe {
        Box::from_raw(revocation_registry_delta as *mut RevocationRegistryDelta);
    };
    trace!(
        "indy_crypto_cl_revocation_registry_delta_free: entity: revocation_registry_delta: {:?}",
        revocation_registry_delta
    );
    let res = ErrorCode::Success;

    trace!(
        "indy_crypto_cl_revocation_registry_delta_free: <<< res: {:?}",
        res
    );
    res
}
...
pub extern "C" fn indy_crypto_revocation_registry_delta_from_parts(
    ...
    trace!(
        "indy_crypto_revocation_registry_delta_from_parts: rev_reg_delta: {:?}",
        rev_reg_delta
    );
    ...
    unsafe {
        *rev_reg_delta_p = Box::into_raw(Box::new(rev_reg_delta)) as *const c_void;
        trace!(
            "indy_crypto_revocation_registry_delta_from_parts: *rev_reg_delta_p: {:?}",
            *rev_reg_delta_p
        );
    }
    ...
    trace!(
        "indy_crypto_revocation_registry_delta_from_parts: <<< res: {:?}",
        res
    );
    res
}
...
pub extern "C" fn indy_crypto_cl_issuer_revoke_credential(
    ...
    trace!(
        "indy_crypto_cl_issuer_revoke_credential: entities: rev_reg: {:?}",
        secret!(&rev_reg)
    );
    ...
    let res = match Issuer::revoke_credential(rev_reg, max_cred_num, rev_idx, &rta) {
        Ok(rev_reg_delta) => {
            unsafe {
                *rev_reg_delta_p = Box::into_raw(Box::new(rev_reg_delta)) as *const c_void;
                trace!(
                    "indy_crypto_cl_issuer_revoke_credential: *rev_reg_delta_p: {:?}",
                    *rev_reg_delta_p
                );
            }
            ErrorCode::Success
    ...
    trace!(
        "indy_crypto_cl_issuer_revoke_credential: <<< res: {:?}",
        res
    );
    ErrorCode::Success
}
...
#[no_mangle]
#[allow(unused_variables)]
pub extern "C" fn indy_crypto_cl_issuer_recovery_credential(
    rev_reg: *const c_void,
    max_cred_num: u32,
    rev_idx: u32,
    ctx_tails: *const c_void,
    ...
    trace!(
        "indy_crypto_cl_issuer_recovery_credential: entities: rev_reg: {:?}",
        rev_reg
    );
    ...
    let res = match Issuer::recovery_credential(rev_reg, max_cred_num, rev_idx, &rta) {
        Ok(rev_reg_delta) => {
            unsafe {
                *rev_reg_delta_p = Box::into_raw(Box::new(rev_reg_delta)) as *const c_void;
                trace!(
                    "indy_crypto_cl_issuer_recovery_credential: *rev_reg_delta_p: {:?}",
                    *rev_reg_delta_p
                );
            }
            ErrorCode::Success
    ...
    trace!(
        "indy_crypto_cl_issuer_recovery_credential: <<< res: {:?}",
        res
    );
    ErrorCode::Success
}
...
pub extern "C" fn indy_crypto_cl_issuer_merge_revocation_registry_deltas(
    ...
    let res = match revoc_reg_delta.merge(other_revoc_reg_delta) {
        Ok(merged_revoc_reg_delta) => {
            ...
            unsafe {
                *merged_revoc_reg_delta_p =
                    Box::into_raw(Box::new(merged_revoc_reg_delta)) as *const c_void;
    ...
    trace!(
        "indy_crypto_cl_issuer_merge_revocation_registry_deltas: <<< res: {:?}",
        res
    );
    res
}
...
mod tests {
    ...
    fn indy_crypto_cl_issuer_new_credential_def_works() {
        ...
        let err_code = indy_crypto_cl_issuer_new_credential_def(
            credential_schema,
            non_credential_schema,
            true,
    ...
    fn indy_crypto_cl_credential_public_key_to_json_works() {
        ...
        let err_code = indy_crypto_cl_credential_public_key_to_json(
            credential_pub_key,
    ...
    fn indy_crypto_cl_credential_public_key_from_json_works() {
        ...
        let err_code = indy_crypto_cl_credential_public_key_from_json(
    ...
    fn indy_crypto_cl_credential_private_key_to_json_works() {
        ...
        let err_code = indy_crypto_cl_credential_private_key_to_json(
            credential_priv_key,
    ...
    fn indy_crypto_cl_credential_private_key_from_json_works() {
        ...
        let err_code = indy_crypto_cl_credential_private_key_from_json(
    ...
    fn indy_crypto_cl_credential_key_correctness_proof_to_json_works() {
        ...
        let err_code = indy_crypto_cl_credential_key_correctness_proof_to_json(
            credential_key_correctness_proof,
    ...
    fn indy_crypto_cl_issuer_key_correctness_proof_from_json_works() {
        ...
        let err_code = indy_crypto_cl_credential_key_correctness_proof_from_json(
            credential_key_correctness_proof_json_p,
    ...
    fn indy_crypto_cl_issuer_new_revocation_registry_def_works() {
        ...
        let err_code = indy_crypto_cl_issuer_new_revocation_registry_def(
            credential_pub_key,
            100,
            false,
            &mut rev_key_pub_p,
    ...
    fn indy_crypto_cl_revocation_key_public_to_json_works() {
        ...
        let err_code =
            indy_crypto_cl_revocation_key_public_to_json(rev_key_pub, &mut rev_key_pub_json_p);
        assert_eq!(err_code, ErrorCode::Success);
    ...
    fn indy_crypto_cl_revocation_key_public_from_json_works() {
        ...
        let mut rev_key_pub_p: *const c_void = ptr::null();
        let err_code =
            indy_crypto_cl_revocation_key_public_from_json(rev_key_pub_json_p, &mut rev_key_pub_p);
        assert_eq!(err_code, ErrorCode::Success);
    ...
    fn indy_crypto_cl_revocation_key_private_to_json_works() {
        ...
        let err_code =
            indy_crypto_cl_revocation_key_private_to_json(rev_key_priv, &mut rev_key_priv_json_p);
        assert_eq!(err_code, ErrorCode::Success);
    ...
    fn indy_crypto_cl_revocation_key_private_from_json_works() {
        ...
        let mut rev_key_priv_p: *const c_void = ptr::null();
        let err_code = indy_crypto_cl_revocation_key_private_from_json(
            rev_key_priv_json_p,
            &mut rev_key_priv_p,
        );
        assert_eq!(err_code, ErrorCode::Success);
    ...
    fn indy_crypto_cl_revocation_tails_generator_to_json_works() {
        ...
        let err_code = indy_crypto_cl_revocation_tails_generator_to_json(
            rev_tails_generator,
    ...
    fn indy_crypto_cl_revocation_tails_generator_from_json_works() {
        ...
        let mut rev_tails_generator_p: *const c_void = ptr::null();
        let err_code = indy_crypto_cl_revocation_tails_generator_from_json(
    ...
    fn indy_crypto_cl_issuer_sign_credential_with_revoc_works() {
        ...
        let err_code = indy_crypto_cl_issuer_sign_credential_with_revoc(
            prover_id.as_ptr(),
            blinded_credential_secrets,
            blinded_credential_secrets_correctness_proof,
            credential_nonce,
    ...
    fn indy_crypto_cl_issuer_sign_credential_works() {
        ...
        let mut credential_signature_p: *const c_void = ptr::null();
        let mut credential_signature_correctness_proof_p: *const c_void = ptr::null();
        let err_code = indy_crypto_cl_issuer_sign_credential(
            prover_id.as_ptr(),
            blinded_credential_secrets,
            blinded_credential_secrets_correctness_proof,
            credential_nonce,
    ...
    fn indy_crypto_cl_credential_signature_to_json_works() {
        ...
        let err_code = indy_crypto_cl_credential_signature_to_json(
            credential_signature,
    ...
    fn indy_crypto_cl_credential_signature_from_json_works() {
        ...
        let mut credential_signature_p: *const c_void = ptr::null();
        let err_code = indy_crypto_cl_credential_signature_from_json(
    ...
    fn indy_crypto_cl_signature_correctness_proof_to_json_works() {
        ...
        let err_code = indy_crypto_cl_signature_correctness_proof_to_json(
            signature_correctness_proof,
    ...
    fn indy_crypto_cl_signature_correctness_proof_from_json_works() {
        ...
        let err_code = indy_crypto_cl_signature_correctness_proof_from_json(
            signature_correctness_proof_json_p,
    ...
    fn indy_crypto_cl_issuer_revoke_credential_works() {
        ...
        let err_code = indy_crypto_cl_issuer_revoke_credential(
            rev_reg,
            5,
            1,
            tail_storage.get_ctx(),
    ...
    fn indy_crypto_cl_revocation_registry_delta_from_parts_works() {
        ...
        let err_code = indy_crypto_revocation_registry_delta_from_parts(
            rev_reg_from,
            rev_reg,
            issued,
            issued_len,
    ...
    fn indy_crypto_cl_issuer_merge_revoc_deltas_works() {
        ...
        let err_code = indy_crypto_cl_issuer_merge_revocation_registry_deltas(
            revocation_registry_delta,
            revocation_registry_delta_p,
